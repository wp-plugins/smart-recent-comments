...
= Screencast =
This short screencast demonstrates how to use the Smart Recent Comments plugin. View it [here](http://www.clevelandwebdeveloper.com/wordpress-plugins/smart-recent-comments/).

== Installation ==

1. From WP admin > Plugins > Add New
1. Search "Smart Recent Comments" under search and hit Enter
1. Click "Install Now"
...
1. The problem: Default behavior of WordPress recent comments widget when there are no comments to show
